...
void pid_o() {
    ...
    // gPad->GetCanvas()->Print("figs/o18.pdf");
    ...
    // gPad->GetCanvas()->Print("figs/o19.pdf");
    ...
    // gPad->GetCanvas()->Print("figs/o20.pdf");
    ...
    // gPad->GetCanvas()->Print("figs/o21.pdf");
    ...
    // gPad->GetCanvas()->Print("figs/o22.pdf");
    ...
    // h_sum->Draw("colz");
    // ko_o22.DrawAllCuts(true);
    // gPad->GetCanvas()->Print("figs/o_sum.pdf");
}
