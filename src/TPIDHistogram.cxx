...
TPIDHistograms::TPIDHistograms(const char *_name, TClonesArray *_f2pladata, TClonesArray *_f3pladata,
                               TClonesArray *_f2ssddata, TClonesArray *_f3ssddata) {
    name = _name;
...
void TPIDHistograms::BeginRun(int transition, int run, int time) { CreateHistograms(); }
