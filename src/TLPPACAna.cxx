...
void TLPPACAna::SetData(TGenericData *rdata) {
  ...
  for (int i = 0; i < data[0].size(); i++) rawdata->AppendTXL1(data[0][i]);
  for (int i = 0; i < data[1].size(); i++) rawdata->AppendTXL2(data[1][i]);
  for (int i = 0; i < data[2].size(); i++) rawdata->AppendTXC1(data[2][i]);
  for (int i = 0; i < data[3].size(); i++) rawdata->AppendTXC2(data[3][i]);
  for (int i = 0; i < data[4].size(); i++) rawdata->AppendTXR1(data[4][i]);
  for (int i = 0; i < data[5].size(); i++) rawdata->AppendTXR2(data[5][i]);
  for (int i = 0; i < data[6].size(); i++) rawdata->AppendTY1(data[6][i]);
  for (int i = 0; i < data[7].size(); i++) rawdata->AppendTY2(data[7][i]);
  for (int i = 0; i < data[8].size(); i++) rawdata->AppendTA(data[8][i]);
  ////////////////////////////////////////////////////////////////////
  flagData = true;
