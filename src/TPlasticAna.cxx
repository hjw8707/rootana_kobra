...
void TPlasticAna::Analysis() {
    ...
    // single channel case
    if (n == 1) {
        for (auto it = data[0].begin(); it != data[0].end(); it++) Processing(*it, 0);
...
TPlasticData *TPlasticAna::Processing(uint32_t tl, uint32_t tr) {
    ...
    //////////////////////////////////////////////////////////////////
    // Tdiff cut
    if (tdiff < tdiff_cut[0] || tdiff > tdiff_cut[1]) return nullptr;
    //////////////////////////////////////////////////////////////////
...
void TPlasticAna::PrintParameters() {
    ...
    std::cout << "\n";
    std::cout << " Tdiff cuts: " << tdiff_cut[0] << " " << tdiff_cut[1];
    std::cout << "\n";
}
